...
const imageSources = {
  completed: require('ss/common/components/Item/images/completed.png'),
  'in-progress': require('ss/common/components/Item/images/in-progress.png'),
  'not-started': require('ss/common/components/Item/images/not-started.png')
}
